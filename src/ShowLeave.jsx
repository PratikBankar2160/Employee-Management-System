...
//     // let [reason,setReason] = useSate("");
//     // let [fromDate,setFromDate] = useSate("");
//     // let [toDate,setTodate] = useSate("");
...
//             .catch(() => alert("Something wrong in get"));
//     }, []);


//     let Delete = (id) => {
//         axios.delete(`http://localhost:8080/leave/cancel/${id}`)
//             .then(() => {
...
//                                                 <td>
//                                                     <span className={`badge px-3 py-2 ${leave.status === "Approved"
//                                                         ? "bg-success"
...
//                                                         {/* <button className="btn btn-sm btn-outline-primary" onClick={()=>{navigate(`/updateLeave/${leave.id}`)}}>
//                                                             Update
//                                                         </button> */}
...
//                                     ) : (
//                                         <tr>
//                                             <td colSpan="8" className="text-center fw-semibold">
